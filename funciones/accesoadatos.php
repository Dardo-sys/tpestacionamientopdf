...
class AccesoDatos
{
 ...
 /*
    ...
    {
        try { 
            $this->objetoPDO = new PDO('mysql:host=localhost;dbname=istic2019a;charset=utf8', 'root', '', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
